...
## Chapitre 2: partie 1 - il faut le mettre où exactement `<!DOCTYPE html>` ?
  ...
  - Imaginez qu'un petit automate va "lire" votre document de haut en bas. Eh bien, il faut l'aider à comprendre que votre fichier est un fichier de type `html` ! Si vous mettez `<!DOCTYPE html>` au tout début. C'est la 1ère ligne qu'il va lire ! Il va donc "savoir" que le reste doit être interprété comme du html.
