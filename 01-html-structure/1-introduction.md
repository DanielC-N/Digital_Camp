...
1. Prenez en main [JsFiddle](https://jsfiddle.net/) avec son [tutoriel](../tuto-js-fiddle.md).
2. Dans l'éditeur de code tapez votre nom entre `<h1>` et `</h1>` (supprimez ce qu'il y a déjà), puis appuyez sur Run.
