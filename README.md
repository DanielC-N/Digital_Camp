...
Tout commence ici : [Introduction](01-html-structure/1-introduction.md)  
...
└── 01-html-structure/    # premier dossier à étudier
│       ├── 1-introduction.md # premier exercice à étudier
│       ├── ...
│       └── 15-video.md # dernier exercice à étudier
│              
└── 02-html-standard/    # second dossier à étudier
│       ├── ...
...
Afin de vous évaluer dans les meilleures conditions, nous vous évaluerons sur le rendu des quiz afin de suivre votre avancement ainsi que le rendu du projet final : à rendre pour le **dimanche 19/09/2021** à **23h59** heure de Paris.
