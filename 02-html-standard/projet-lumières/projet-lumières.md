...
- `https://upload.wikimedia.org/wikipedia/commons/3/3a/F%C3%AAte_des_Lumi%C3%A8res_-_Lyon_%282008%29.JPG` 
  - avec une taille de `240` hauteur x `320` largeur
- `https://upload.wikimedia.org/wikipedia/commons/3/30/TCL-crowd.JPG`
  - avec une taille de `240` hauteur x `320` largeur
- `https://upload.wikimedia.org/wikipedia/commons/5/57/Lumignons_fete_des_Lumieres_Lyon_8-12-2013.jpg` 
  - avec une taille de `240` hauteur x `320` largeur
...
| [Précédent](../10-bonnes-pratiques.md)       |   [Quiz-TODO]()  | [Suivant : 3-table-html](../../03-table-html/1-prise-en-main.md)        |
