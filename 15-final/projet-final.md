...
Vous possédez maintenant les compétences nécessaires pour créer des sites web ! Il est temps de mettre en pratique tout ce que vous avez appris.
...
L'objectif de cette activité est de réaliser la même architecture que [maquette.png](./maquette.png) tout en **personnalisant** et **adaptant le contenu** de la page selon vos envies.  

## Critères de rendu

Nous noterons uniquement la forme et **la forme SEULE**. Le contenu des images et du texte est libre (restez décent tout de même).  
...
L'organisation du dossier comportant tous les fichiers doit s'organiser comme ci-dessous:
...
### Lien vers le dépôt : <a href="https://moodle.ucly.fr/21-22/mod/assign/view.php?id=17528" target="_blank">Soon...</a>
...
1. Un header composé de:
     ...
     - Des liens de navigations pour les différents éléments de la page ([ancrage](../02-html-standard/9-lien-5.md))
